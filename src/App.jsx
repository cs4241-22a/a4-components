...
class Item extends React.Component {
  ...
  render() {
    return <ul class="container">
      <li class="box" id="name-col">{this.props.name}</li>
      <li class="box">{this.props.qty}</li>
      <li class="box">{this.props.units}</li>
      <li class="box">{this.props.brand}</li>
    </ul>
  }
...
class App extends React.Component {
  ...
  render() {
    return (
      ...
      <h2>Current List</h2>
      {/* <p class="column-label">Item</p>
      <p class="column-label">Quantity</p>
      <p class="column-label">Units</p>
      <p class="column-label">Brand</p> */}
      <p class="column-label">Item &nbsp; Quantity &nbsp; Units &nbsp; Brand</p>
      <div>
          { this.state.items.map( (item,i) => <Item key={i} name={item.name} qty={item.qty} units={item.units} brand={item.brand} /> ) }
       </div>
      <br />
      ...
      <div class="delete-form">
        ...
        <button onClick={ e => this.remove( e )} id="delete-button">delete</button>
      </div>
      </div>
    )
  }
